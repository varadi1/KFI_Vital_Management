...
function loadingscreen(job)
{
    ...
    ls.append("<div id='loadingscreeninstructions' class='button'>Használati utasítás</div>");
    ls.append("<div id='loadingscreentext'>Videó betöltése...</div>");
    ls.append("<div id='loadingscreenslider'></div>");

    if (!mturk_isassigned())
    {
        ls.append("<div class='loadingscreentip'><strong></div>");
    }

    ls.append("<div class='loadingscreentip'></div>");
